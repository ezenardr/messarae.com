						...
						<div className="row">
							<div className="col-lg-4 offset-lg-1">
								...
								<div className="d-flex flex-column gap-2 mt-9 position-relative z-1">
									<Link href="tel:+14383427100">
										<i className="ri-phone-fill text-primary-3 fs-7" />
										<span className="text-300 fs-6 ms-2">+1-438-342-7100</span>
									</Link>
									...
									<Link href="https://www.google.com/maps/place/1st+Ave.,+New+York,+NY,+Hoa+K%E1%BB%B3/@40.7630169,-73.9594939,17z/data=!4m6!3m5!1s0x89c258c29e084453:0x2bf768350d30b89e!8m2!3d40.7630169!4d-73.9594939!16zL20vMDV3Z2tm?entry=ttu&g_ep=EgoyMDI0MDkxNi4wIKXMDSoASAFQAw%3D%3D">
										...
										<span className="text-300 fs-6 ms-2">Ottawa, CA</span>
									</Link>
								</div>
							</div>
							<div className="col-lg-7 pt-lg-0 pt-8">
								<div id="about" className="hero-3 pe-lg-5 border-bottom pb-7">
									...
									<p className="mb-8">Bienvenue dans l'univers créatif de Messara Ezenard, où les mots se transforment en récits captivants et en contenus enrichissants. Découvrez son parcours en tant qu'écrivaine primée et explorez comment elle donne vie à l'imagination grâce à sa voix unique et ses récits passionnants.</p>
									...
									<div className="card-services mb-3 pt-4">
										<div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-4 p-md-4 p-3 d-flex">
											...
											<div className="card__content px-md-4 px-3">
												<div className="card__title mb-0 mb-lg-2">
													<Link href="#">
														<p className="fs-4 text-dark">Écriture : Romans, nouvelles et poésie.</p>
													</Link>
												</div>
												<p className="text-300 mb-lg-auto mb-md-4 mb-3">Que vous recherchiez un roman immersif, une nouvelle captivante ou une poésie évocatrice, je suis l’écrivaine qu’il vous faut. Avec une maîtrise approfondie du développement des personnages, de la structure narrative et de la prose lyrique, je crée des histoires qui touchent et inspirent.</p>
											</div>
										</div>
									</div>
									...
									<div className="card-services mb-3">
										<div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-4 p-md-4 p-3 d-flex">
											...
											<div className="card__content px-md-4 px-3">
												<div className="card__title mb-0 mb-lg-2">
													<Link href="#">
														<p className="fs-4 text-dark">Révision et correction avec précision.</p>
													</Link>
												</div>
												<p className="text-300 mb-lg-auto mb-md-4 mb-3">Valorisez votre marque avec des récits captivants et un contenu mémorable qui résonne auprès de votre audience.</p>
											</div>
										</div>
									</div>
									<div className="card-services mb-3">
										<div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-4 p-md-4 p-3 d-flex">
											...
											<div className="card__content px-md-4 px-3">
												<div className="card__title mb-0 mb-lg-2">
													<Link href="#">
														<p className="fs-4 text-dark">Rédaction optimisée pour le référencement (SEO).</p>
													</Link>
												</div>
												<p className="text-300 mb-lg-auto mb-md-4 mb-3">Améliorez votre visibilité en ligne grâce à notre contenu optimisé pour le référencement (SEO), conçu pour mieux se classer et attirer davantage de visiteurs.</p>
											</div>
										</div>
									</div>
								</div>
